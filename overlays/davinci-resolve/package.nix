    ...
    stdenv.mkDerivation rec {
      ...
      src =
        if studioVariant then
          requireFile {
            name = "DaVinci_Resolve_Studio_${version}_Linux.zip";
            url = "https://drive.google.com/file/d/1m71Y-i0typv1x_qgFis0R5KIUCmIrV2w/view";
            hash = "sha256-0uUC2qAKYOvgCvYrYIzNP93htJCozqYqIwMTPsAWUr0=";
          }
        else
          runCommandLocal "${pname}-src.zip"
            rec {
              ...
              outputHash = "sha256-3mZWP58UZYS4U1f9M3TZ9wyto0cGy+KdB+GIJlvCVng=";
